...
> 使用call 或 apply 方法, 将父对象的构造函数绑定在子对象上.
...
除去上述方法，Promise还有其他用法，小伙伴们可以在这里查看大佬写的文章 [ES6入门-阮一峰](http://es6.ruanyifeng.com/#README)
...
> `export` 与 `export default` 均可以导出常量, 函数, 文件, 模块等
